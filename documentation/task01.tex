...
Před každým měřením by mělo být jasně dáno co chceme měřit.
...
https://searchsoftwarequality.techtarget.com/tip/23-software-development-metrics-to-track-today
